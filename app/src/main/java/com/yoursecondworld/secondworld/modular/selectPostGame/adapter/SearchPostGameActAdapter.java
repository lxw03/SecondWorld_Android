 ...
 */
public class SearchPostGameActAdapter extends CommonRecyclerViewAdapter<String> {
     ...
     * @param data    显示的数据
     */
    public SearchPostGameActAdapter(Context context, List<String> data) {
        super(context, data);
    }
    ...
    public int getLayoutViewId(int viewType) {
        return R.layout.act_search_post_game_item;
    }
